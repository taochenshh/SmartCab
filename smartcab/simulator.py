...
class Simulator(object):
    ...
    def run(self, n_trials=1):
        ...
        num_trials = self.env.num_hit_time_limit + self.env.num_out_of_time + self.env.num_succ

        print "================================================================================"
        print "Results: "
        print "       Number of successful trials: ",self.env.num_succ
        print "       Number of failed trials that ran out of time: ", self.env.num_out_of_time
        print "       Number of failed trials that hit the hard time limit: ", self.env.num_hit_time_limit
        print "       Number of total trials: ", num_trials
        print "       Success rate: {:.2f}%".format(100 * self.env.num_succ / float(num_trials))
        print "       Total Penalty Number: {:d}".format(self.env.primary_agent.penalty_num)
        print "       Total Moves: {:d}".format(self.env.primary_agent.move_num)
